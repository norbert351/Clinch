    ...
    <nav className="sticky top-0 z-50 border-b border-clinch-border-default/80 bg-clinch-bg-page/72 backdrop-blur-2xl supports-[backdrop-filter]:bg-clinch-bg-page/58">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2.5">
          <Link href="/docs"
            className="hidden sm:inline-flex items-center gap-1.5 rounded-md border border-[var(--border-subtle)] px-3 py-1.5 font-sans text-[12px] font-medium text-[var(--text-secondary)] hover:text-[var(--accent-cyan)] hover:border-[var(--accent-cyan)]/30 transition-all"
          >
